...
template <>
void initPackingContext(::zserio::DeltaContext& context, ::tutorial::Language value)
{
    context.init<::zserio::BitFieldArrayTraits<typename ::std::underlying_type<::tutorial::Language>::type, UINT8_C(2)>>(
...
template <>
size_t bitSizeOf(::zserio::DeltaContext& context, ::tutorial::Language value)
{
    return context.bitSizeOf<::zserio::BitFieldArrayTraits<typename ::std::underlying_type<::tutorial::Language>::type, UINT8_C(2)>>(
            ::zserio::enumToValue(value));
}
...
template <>
size_t initializeOffsets(::zserio::DeltaContext& context, size_t bitPosition, ::tutorial::Language value)
{
...
template <>
::tutorial::Language read(::zserio::DeltaContext& context, ::zserio::BitStreamReader& in)
{
    return valueToEnum<::tutorial::Language>(context.read<::zserio::BitFieldArrayTraits<typename ::std::underlying_type<::tutorial::Language>::type, UINT8_C(2)>>(
            in));
}
...
template <>
void write(::zserio::DeltaContext& context, ::zserio::BitStreamWriter& out, ::tutorial::Language value)
{
    context.write<::zserio::BitFieldArrayTraits<typename ::std::underlying_type<::tutorial::Language>::type, UINT8_C(2)>>(
...
template <>
void initPackingContext(::zserio::DeltaContext& context, ::tutorial::Role value)
{
    context.init<::zserio::StdIntArrayTraits<typename ::std::underlying_type<::tutorial::Role>::type>>(
            ::zserio::enumToValue(value));
}
...
template <>
size_t bitSizeOf(::zserio::DeltaContext& context, ::tutorial::Role value)
{
    return context.bitSizeOf<::zserio::StdIntArrayTraits<typename ::std::underlying_type<::tutorial::Role>::type>>(
            ::zserio::enumToValue(value));
}
...
template <>
size_t initializeOffsets(::zserio::DeltaContext& context, size_t bitPosition, ::tutorial::Role value)
{
    return bitPosition + bitSizeOf(context, value);
}
...
template <>
::tutorial::Role read(::zserio::DeltaContext& context, ::zserio::BitStreamReader& in)
{
    return valueToEnum<::tutorial::Role>(context.read<::zserio::StdIntArrayTraits<typename ::std::underlying_type<::tutorial::Role>::type>>(
            in));
}
...
template <>
void write(::zserio::DeltaContext& context, ::zserio::BitStreamWriter& out, ::tutorial::Role value)
{
    context.write<::zserio::StdIntArrayTraits<typename ::std::underlying_type<::tutorial::Role>::type>>(
            out, ::zserio::enumToValue(value));
}
...
Employee::Employee(Employee::ZserioPackingContext& context, ::zserio::BitStreamReader& in, const allocator_type& allocator) :
        m_age_(readAge(context, in)),
        m_name_(readName(in, allocator)),
        m_salary_(readSalary(context, in)),
        m_bonus_(readBonus(context, in)),
        m_role_(readRole(context, in)),
        m_skills_(readSkills(context, in, allocator))
{
}
...
void Employee::initPackingContext(Employee::ZserioPackingContext& context) const
{
    context.getAge().init<::zserio::StdIntArrayTraits<uint8_t>>(m_age_);
    context.getSalary().init<::zserio::StdIntArrayTraits<uint16_t>>(m_salary_);
    if (isBonusSet())
    {
        context.getBonus().init<::zserio::StdIntArrayTraits<uint16_t>>(m_bonus_.value());
    }
    ::zserio::initPackingContext(context.getRole(), m_role_);
}
...
size_t Employee::bitSizeOf(Employee::ZserioPackingContext& context, size_t bitPosition) const
{
    size_t endBitPosition = bitPosition;

    endBitPosition += context.getAge().bitSizeOf<::zserio::StdIntArrayTraits<uint8_t>>(m_age_);
    endBitPosition += ::zserio::bitSizeOfString(m_name_);
    endBitPosition += context.getSalary().bitSizeOf<::zserio::StdIntArrayTraits<uint16_t>>(m_salary_);
    endBitPosition += 1;
    if (isBonusSet())
    {
        endBitPosition += context.getBonus().bitSizeOf<::zserio::StdIntArrayTraits<uint16_t>>(m_bonus_.value());
    }
    endBitPosition += ::zserio::bitSizeOf(context.getRole(), m_role_);
    if (getRole() == ::tutorial::Role::DEVELOPER)
    {
        endBitPosition += m_skills_.value().bitSizeOfPacked(*this, endBitPosition);
    }
...
size_t Employee::initializeOffsets(Employee::ZserioPackingContext& context, size_t bitPosition)
{
    size_t endBitPosition = bitPosition;
    ...
    endBitPosition = ::zserio::initializeOffsets(context.getRole(), endBitPosition,
        m_role_);
    if (getRole() == ::tutorial::Role::DEVELOPER)
    {
        endBitPosition = m_skills_.value().initializeOffsetsPacked(*this, endBitPosition);
    }
...
void Employee::write(Employee::ZserioPackingContext& context, ::zserio::BitStreamWriter& out) const
{
    // check constraint
    if (!(getAge() <= 65))
        throw ::zserio::ConstraintException("Write: Constraint violated at Employee.age!");
    context.getAge().write<::zserio::StdIntArrayTraits<uint8_t>>(out, m_age_);

    out.writeString(m_name_);

    context.getSalary().write<::zserio::StdIntArrayTraits<uint16_t>>(out, m_salary_);

    if (isBonusSet())
    {
        out.writeBool(true);
        context.getBonus().write<::zserio::StdIntArrayTraits<uint16_t>>(out, m_bonus_.value());
    }
    else
    {
        out.writeBool(false);
    ...
    ::zserio::write(context.getRole(), out, m_role_);

    if (getRole() == ::tutorial::Role::DEVELOPER)
    {
        m_skills_.value().writePacked(*this, out);
    }
}
...
void Employee::ZserioElementFactory_skills::create(Employee&        ,
        ::zserio::vector<::tutorial::Experience>& array,
        ::tutorial::Experience::ZserioPackingContext& context, ::zserio::BitStreamReader& in,
        size_t)
{
...
uint8_t Employee::readAge(Employee::ZserioPackingContext& context, ::zserio::BitStreamReader& in)
{
    uint8_t readField = context.getAge().read<::zserio::StdIntArrayTraits<uint8_t>>(in);
    // check constraint
    if (!(readField <= 65))
        throw ::zserio::ConstraintException("Read: Constraint violated at Employee.age!");
...
uint16_t Employee::readSalary(Employee::ZserioPackingContext& context, ::zserio::BitStreamReader& in)
{
    return context.getSalary().read<::zserio::StdIntArrayTraits<uint16_t>>(in);
}
...
::zserio::InplaceOptionalHolder<uint16_t> Employee::readBonus(Employee::ZserioPackingContext& context, ::zserio::BitStreamReader& in)
{
    if (in.readBool())
    {
        return ::zserio::InplaceOptionalHolder<uint16_t>(context.getBonus().read<::zserio::StdIntArrayTraits<uint16_t>>(in));
    }
...
::tutorial::Role Employee::readRole(Employee::ZserioPackingContext& context, ::zserio::BitStreamReader& in)
{
    return ::zserio::read<::tutorial::Role>(context.getRole(), in);
}
...
::zserio::InplaceOptionalHolder<Employee::ZserioArrayType_skills> Employee::readSkills(Employee::ZserioPackingContext&, ::zserio::BitStreamReader& in, const allocator_type& allocator)
{
    if (getRole() == ::tutorial::Role::DEVELOPER)
    {
        ZserioArrayType_skills readField(allocator);
...
Experience::Experience(Experience::ZserioPackingContext& context, ::zserio::BitStreamReader& in, const allocator_type&) :
        m_yearsOfExperience_(readYearsOfExperience(context, in)),
        m_programmingLanguage_(readProgrammingLanguage(context, in))
{
}
...
void Experience::initPackingContext(Experience::ZserioPackingContext& context) const
{
    context.getYearsOfExperience().init<::zserio::BitFieldArrayTraits<uint8_t, UINT8_C(6)>>(m_yearsOfExperience_);
    ::zserio::initPackingContext(context.getProgrammingLanguage(), m_programmingLanguage_);
}
...
size_t Experience::bitSizeOf(Experience::ZserioPackingContext& context, size_t bitPosition) const
{
    size_t endBitPosition = bitPosition;

    endBitPosition += context.getYearsOfExperience().bitSizeOf<::zserio::BitFieldArrayTraits<uint8_t, UINT8_C(6)>>(m_yearsOfExperience_);
    endBitPosition += ::zserio::bitSizeOf(context.getProgrammingLanguage(), m_programmingLanguage_);
...
size_t Experience::initializeOffsets(Experience::ZserioPackingContext& context, size_t bitPosition)
{
    size_t endBitPosition = bitPosition;

    endBitPosition += context.getYearsOfExperience().bitSizeOf<::zserio::BitFieldArrayTraits<uint8_t, UINT8_C(6)>>(m_yearsOfExperience_);
    endBitPosition = ::zserio::initializeOffsets(context.getProgrammingLanguage(), endBitPosition,
...
void Experience::write(Experience::ZserioPackingContext& context, ::zserio::BitStreamWriter& out) const
{
    context.getYearsOfExperience().write<::zserio::BitFieldArrayTraits<uint8_t, UINT8_C(6)>>(out, m_yearsOfExperience_);
    ::zserio::write(context.getProgrammingLanguage(), out, m_programmingLanguage_);
}
...
uint8_t Experience::readYearsOfExperience(Experience::ZserioPackingContext& context, ::zserio::BitStreamReader& in)
{
    return context.getYearsOfExperience().read<::zserio::BitFieldArrayTraits<uint8_t, UINT8_C(6)>>(in);
}
...
::tutorial::Language Experience::readProgrammingLanguage(Experience::ZserioPackingContext& context, ::zserio::BitStreamReader& in)
{
    return ::zserio::read<::tutorial::Language>(context.getProgrammingLanguage(), in);
}
