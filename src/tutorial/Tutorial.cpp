...
template <>
size_t bitSizeOf(::zserio::PackingContextNode& contextNode, size_t bitPosition, ::tutorial::Language value)
{
...
template <>
void write(BitStreamWriter& out, ::tutorial::Language value)
{
    out.writeBits(enumToValue(value), UINT8_C(2));
}

template <>
void write(::zserio::PackingContextNode& contextNode, BitStreamWriter& out, ::tutorial::Language value)
{
...
template <>
size_t bitSizeOf(::zserio::PackingContextNode& contextNode, size_t bitPosition, ::tutorial::Role value)
{
    return contextNode.getContext().bitSizeOf(
...
template <>
void write(BitStreamWriter& out, ::tutorial::Role value)
{
    out.writeBits(enumToValue(value), UINT8_C(8));
}

template <>
void write(::zserio::PackingContextNode& contextNode, BitStreamWriter& out, ::tutorial::Role value)
{
    contextNode.getContext().write(
            ::zserio::StdIntArrayTraits<typename ::std::underlying_type<::tutorial::Role>::type>(),
            out, enumToValue(value));
...
Employee::ElementFactory_skills::ElementFactory_skills(Employee& owner) :
        m_owner(owner)
{}

void Employee::ElementFactory_skills::create(::std::vector<::tutorial::Experience>& array,
...
void Employee::ElementFactory_skills::create(::zserio::PackingContextNode& contextNode,
        ::std::vector<::tutorial::Experience>& array, ::zserio::BitStreamReader& in, size_t index) const
{
    (void)index;
...
{
    m_skills_ = ArrayType_skills(skills_, ::zserio::ObjectArrayTraits<::tutorial::Experience, ElementFactory_skills>());
}

void Employee::setSkills(::std::vector<::tutorial::Experience>&& skills_)
{
    m_skills_ = ArrayType_skills(std::move(skills_), ::zserio::ObjectArrayTraits<::tutorial::Experience, ElementFactory_skills>());
}
...
{
    contextNode.getChildren().at(0).getContext().init(m_age_);
    contextNode.getChildren().at(2).getContext().init(m_salary_);
    if (m_bonus_.hasValue())
    {
        contextNode.getChildren().at(3).getContext().init(m_bonus_.value());
    }
    contextNode.getChildren().at(4).getContext().init(
            ::zserio::enumToValue(m_role_));
}
...
size_t Employee::bitSizeOf(::zserio::PackingContextNode& contextNode, size_t bitPosition) const
{
    ...
    endBitPosition += contextNode.getChildren().at(0).getContext().bitSizeOf(
            ::zserio::StdIntArrayTraits<uint8_t>(), endBitPosition, m_age_);
    endBitPosition += ::zserio::bitSizeOfString(m_name_);
    endBitPosition += contextNode.getChildren().at(2).getContext().bitSizeOf(
            ::zserio::StdIntArrayTraits<uint16_t>(), endBitPosition, m_salary_);
    endBitPosition += 1;
    if (m_bonus_.hasValue())
    {
        endBitPosition += contextNode.getChildren().at(3).getContext().bitSizeOf(
                ::zserio::StdIntArrayTraits<uint16_t>(), endBitPosition, m_bonus_.value());
    }
    endBitPosition += ::zserio::bitSizeOf(
            contextNode.getChildren().at(4), endBitPosition, m_role_);
    if (getRole() == ::tutorial::Role::DEVELOPER)
    {
...
void Employee::write(::zserio::PackingContextNode& contextNode, ::zserio::BitStreamWriter& out)
{
    // check constraint
    if (!(getAge() <= 65))
        throw ::zserio::ConstraintException("Write: Constraint violated at Employee.age!");
    ...
    ::zserio::write(contextNode.getChildren().at(4), out, m_role_);
...
{
    uint8_t readField = contextNode.getChildren().at(0).getContext().read(::zserio::StdIntArrayTraits<uint8_t>(), in);
    // check constraint
    if (!(readField <= 65))
        throw ::zserio::ConstraintException("Read: Constraint violated at Employee.age!");
...
{
    return contextNode.getChildren().at(2).getContext().read(::zserio::StdIntArrayTraits<uint16_t>(), in);
}
...
::zserio::InplaceOptionalHolder<uint16_t> Employee::readBonus(::zserio::PackingContextNode& contextNode, ::zserio::BitStreamReader& in)
{
    if (in.readBool())
    {
        return ::zserio::InplaceOptionalHolder<uint16_t>(contextNode.getChildren().at(3).getContext().read(::zserio::StdIntArrayTraits<uint16_t>(), in));
    }
...
{
    return ::zserio::read<::tutorial::Role>(contextNode.getChildren().at(4), in);
}

::zserio::InplaceOptionalHolder<Employee::ArrayType_skills> Employee::readSkills(::zserio::BitStreamReader& in,
        const allocator_type& allocator)
{
    if (getRole() == ::tutorial::Role::DEVELOPER)
    {
        ArrayType_skills readField(::zserio::ObjectArrayTraits<::tutorial::Experience, ElementFactory_skills>(), allocator);
        readField.read(in, ElementFactory_skills(*this));

        return ::zserio::InplaceOptionalHolder<ArrayType_skills>(::std::move(readField));
    }

    return ::zserio::InplaceOptionalHolder<ArrayType_skills>(::zserio::NullOpt);
}

::zserio::InplaceOptionalHolder<Employee::ArrayType_skills> Employee::readSkills(::zserio::PackingContextNode&, ::zserio::BitStreamReader& in, const allocator_type& allocator)
{
    if (getRole() == ::tutorial::Role::DEVELOPER)
    {
        ArrayType_skills readField(::zserio::ObjectArrayTraits<::tutorial::Experience, ElementFactory_skills>(), allocator);
        readField.readPacked(in, ElementFactory_skills(*this));
...
{
    contextNode.getChildren().at(0).getContext().init(m_yearsOfExperience_);
    contextNode.getChildren().at(1).getContext().init(
            ::zserio::enumToValue(m_programmingLanguage_));
}
...
size_t Experience::bitSizeOf(::zserio::PackingContextNode& contextNode, size_t bitPosition) const
{
    ...
    endBitPosition += contextNode.getChildren().at(0).getContext().bitSizeOf(
            ::zserio::BitFieldArrayTraits<uint8_t>(UINT8_C(6)), endBitPosition, m_yearsOfExperience_);
    endBitPosition += ::zserio::bitSizeOf(
            contextNode.getChildren().at(1), endBitPosition, m_programmingLanguage_);
...
void Experience::write(::zserio::PackingContextNode& contextNode, ::zserio::BitStreamWriter& out)
{
    contextNode.getChildren().at(0).getContext().write(
            ::zserio::BitFieldArrayTraits<uint8_t>(UINT8_C(6)), out, m_yearsOfExperience_);
    ::zserio::write(contextNode.getChildren().at(1), out, m_programmingLanguage_);
}
...
{
    return contextNode.getChildren().at(0).getContext().read(::zserio::BitFieldArrayTraits<uint8_t>(UINT8_C(6)), in);
}
...
{
    return ::zserio::read<::tutorial::Language>(contextNode.getChildren().at(1), in);
}
