...
{
    out.writeBits(enumToValue(value), 2);
}
...
::zserio::OptionalHolder<uint16_t>& Employee::getBonus()
{
    return m_bonus_;
}

const ::zserio::OptionalHolder<uint16_t>& Employee::getBonus() const
{
    return m_bonus_;
}

void Employee::setBonus(const ::zserio::OptionalHolder<uint16_t>& bonus_)
{
    m_bonus_ = bonus_;
}

void Employee::setBonus(::zserio::OptionalHolder<uint16_t>&& bonus_)
{
    m_bonus_ = ::std::move(bonus_);
}
...
::zserio::OptionalHolder<::std::vector<::tutorial::Experience>>& Employee::getSkills()
{
    return m_skills_;
}

const ::zserio::OptionalHolder<::std::vector<::tutorial::Experience>>& Employee::getSkills() const
{
    return m_skills_;
}

void Employee::setSkills(const ::zserio::OptionalHolder<::std::vector<::tutorial::Experience>>& skills_)
{
    m_skills_ = skills_;
}

void Employee::setSkills(::zserio::OptionalHolder<::std::vector<::tutorial::Experience>>&& skills_)
{
...
::zserio::OptionalHolder<uint16_t> Employee::readBonus(::zserio::BitStreamReader& in)
{
    ...
    return ::zserio::OptionalHolder<uint16_t>();
}
...
::zserio::OptionalHolder<::std::vector<::tutorial::Experience>> Employee::readSkills(::zserio::BitStreamReader& in)
{
    ...
    return ::zserio::OptionalHolder<::std::vector<::tutorial::Experience>>();
}
