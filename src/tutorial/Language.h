...
template <>
void initPackingContext<::zserio::DeltaContext, ::tutorial::Language>(::zserio::DeltaContext& context, ::tutorial::Language value);

template <>
size_t bitSizeOf<::tutorial::Language>(::tutorial::Language value);

template <>
size_t bitSizeOf<::zserio::DeltaContext, ::tutorial::Language>(::zserio::DeltaContext& context, ::tutorial::Language value);

template <>
size_t initializeOffsets<::tutorial::Language>(size_t bitPosition, ::tutorial::Language value);

template <>
size_t initializeOffsets<::zserio::DeltaContext, ::tutorial::Language>(::zserio::DeltaContext& context, size_t bitPosition,
        ::tutorial::Language value);

template <>
::tutorial::Language read<::tutorial::Language>(::zserio::BitStreamReader& in);

template <>
::tutorial::Language read<::tutorial::Language, ::zserio::DeltaContext>(::zserio::DeltaContext& context, ::zserio::BitStreamReader& in);

template <>
void write<::tutorial::Language>(::zserio::BitStreamWriter& out, ::tutorial::Language value);

template <>
void write<::zserio::DeltaContext, ::tutorial::Language>(::zserio::DeltaContext& context, ::zserio::BitStreamWriter& out,
        ::tutorial::Language value);
