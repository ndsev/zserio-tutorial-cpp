...
public:
    ...
    public:
        ...
        ::zserio::DeltaContext& getSalary()
        {
            return m_salary_;
        }

        ::zserio::DeltaContext& getBonus()
        {
            return m_bonus_;
        }

        ::zserio::DeltaContext& getRole()
        {
            return m_role_;
        }
    ...
    private:
        ...
        ::zserio::DeltaContext m_salary_;
        ::zserio::DeltaContext m_bonus_;
        ::zserio::DeltaContext m_role_;
    };
    ...
    explicit Employee(ZserioPackingContext& context,
...
private:
    ...
    public:
        ...
        static void create(Employee& owner,
                ::zserio::vector<::tutorial::Experience>& array,
                ::tutorial::Experience::ZserioPackingContext& context,
                ::zserio::BitStreamReader& in, size_t index);
    };
