...
public:
    ...
    ::zserio::OptionalHolder<uint16_t>& getBonus();
    const ::zserio::OptionalHolder<uint16_t>& getBonus() const;
    void setBonus(const ::zserio::OptionalHolder<uint16_t>& bonus_);
    void setBonus(::zserio::OptionalHolder<uint16_t>&& bonus_);
    bool hasBonus() const;

    ::tutorial::Role getRole() const;
    void setRole(::tutorial::Role role_);

    ::zserio::OptionalHolder<::std::vector<::tutorial::Experience>>& getSkills();
    const ::zserio::OptionalHolder<::std::vector<::tutorial::Experience>>& getSkills() const;
    void setSkills(const ::zserio::OptionalHolder<::std::vector<::tutorial::Experience>>& skills_);
    void setSkills(::zserio::OptionalHolder<::std::vector<::tutorial::Experience>>&& skills_);
