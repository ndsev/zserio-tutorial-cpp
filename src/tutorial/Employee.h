...
private:
    ...
    using ZserioArrayType_skills = ::zserio::Array<::std::vector<::tutorial::Experience>, ::zserio::ObjectArrayTraits<::tutorial::Experience, ZserioElementFactory_skills>, ::zserio::ArrayType::AUTO>;
