...
template <>
void initPackingContext<::zserio::DeltaContext, ::tutorial::Role>(::zserio::DeltaContext& context, ::tutorial::Role value);

template <>
size_t bitSizeOf<::tutorial::Role>(::tutorial::Role value);

template <>
size_t bitSizeOf<::zserio::DeltaContext, ::tutorial::Role>(::zserio::DeltaContext& context, ::tutorial::Role value);

template <>
size_t initializeOffsets<::tutorial::Role>(size_t bitPosition, ::tutorial::Role value);

template <>
size_t initializeOffsets<::zserio::DeltaContext, ::tutorial::Role>(::zserio::DeltaContext& context, size_t bitPosition,
        ::tutorial::Role value);
...
template <>
::tutorial::Role read<::tutorial::Role, ::zserio::DeltaContext>(::zserio::DeltaContext& context, ::zserio::BitStreamReader& in);

template <>
void write<::tutorial::Role>(::zserio::BitStreamWriter& out, ::tutorial::Role value);

template <>
void write<::zserio::DeltaContext, ::tutorial::Role>(::zserio::DeltaContext& context, ::zserio::BitStreamWriter& out,
        ::tutorial::Role value);
